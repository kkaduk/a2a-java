 ...
 * Enables discovery and invocation of registered agents based on their skills and capabilities.
 */
@Component
@Slf4j
public class Receptionist {
    ...
    public Mono<List<AgentCapabilityInfo>> findAgentsByCapability(CapabilityQuery capabilityQuery) {
        log.debug("Processing capability query: {}", capabilityQuery);
    ...
    private SendMessageRequest createMessageRequest(SkillInvocationRequest invocationRequest, 
        ...
        Message message = Message.builder()
            ...
            .parts(Collections.singletonList(TextPart.builder()
                .text(invocationRequest.getInput() != null ? 
                      invocationRequest.getInput() : "")
                .build()))
            .build();
